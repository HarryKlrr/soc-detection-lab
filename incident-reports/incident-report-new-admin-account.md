# Incident Report — New Local Administrator Account Created
...
| Field | Detail |
|---|---|
| **Incident Type** | Unauthorised local administrator account creation |
...
| Windows Event IDs | 4720 (account created), 4732 (added to Administrators group) | [Add] |
...
- Disabled the newly created account immediately
- Removed the account from the Administrators group
- Reviewed other accounts for unauthorised privilege changes
...
**Technique:** https://attack.mitre.org/techniques/T1136/001/
