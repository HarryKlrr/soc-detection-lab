...
Sigma rule drafts live separately in [`../draft-rules/`](../draft-rules/) since they haven't been validated against live data and shouldn't be read as tested coverage.
